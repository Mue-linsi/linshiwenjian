                ...
                button.addEventListener('click', function () {
                    ...
                    switch (buttonInfo.id) {
                        ...
                        case 'download-video-with-1dm':
                            if (video_urla) {
                                intentUrl = `intent:${video_urla}#Intent;package=idm.internet.download.manager.plus;scheme=idmdownload;S.title=${title};end`;
                        ...
                        case 'download-video-with-1dmb':
                            if (video_urlb) {
                                intentUrl = `intent:${video_urlb}#Intent;package=idm.internet.download.manager.plus;scheme=idmdownload;S.title=${title};end`;
                                window.open(intentUrl, '_blank');
                            } else {
                                this.textContent = "没有找到视频";
                            }
                        ...
                        case 'download-audio-with-1dm':
                            if (audio_url) {
                                intentUrl = `intent:${audio_url}#Intent;package=idm.internet.download.manager.plus;scheme=idmdownload;S.title=${title};end`;
                                window.open(intentUrl, '_blank');
                            } else {
